...
public class PickleBallField {
   ...
   public PickleBallField() {
    ...
    public String toString() {
        return "PickleBallField{" + "IDPickleBallField=" + IDPickleBallField + ", Name=" + Name + ", TypeofPickleBallField=" + TypeofPickleBallField + ", Price=" + Price + ", Image=" + Image + ", Status=" + Status + '}';
    }
